			...
			<?php
                  ...
                  for($i = 0, $count = sizeof($data); $i < $count; $i++) // выводим данные в виде строк HTML-таблицы 
                  {
                  	...
                  	<div class='row pt-3 input-container'>
						<div class='col-10'>
							<input class='item col-1 ml-2 id_input' type='text' placeholder='ID' value='{$data[$i]['id_medicine']}'>
							<input class='item col-2 ml-2' type='text' placeholder='Title' value='{$data[$i]['title']}'>
							<input class='item col-2 ml-2' type='text' placeholder='Cost' value='{$data[$i]['cost']}'>
							<input class='item col-2 ml-2' type='text' placeholder='Available' value='{$data[$i]['available_in_warehouse']}'>
							<input class='item col-2 ml-2' type='text' placeholder='Amount' value='{$data[$i]['amount']}'>
							<input class='item col-2 ml-2' type='text' placeholder='Rating' value='{$data[$i]['average_rating_by_medicine']}'>
						</div>
						<div class='col-1'>
